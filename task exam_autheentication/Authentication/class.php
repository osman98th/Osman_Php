...
public static function display_result() {
    if(file_exists(self::$file_path)) {
        ...
        echo "<h3 style='text-align: center;'>Information of student</h3>";
        echo "<table style='width: 600px; margin: auto; border-collapse: collapse; font-family: Arial, sans-serif;'>
                <thead>
                    <tr style='background-color: #b3c2b3ff; color: white;'>
        ...
        foreach ($desh as $a) {
            ...
            if (count($parts) === 4) {
                ...
                echo "<tr style='background-color: 97B067;'>
